...
#include "../SPI/SPI.h"
#include "../adapter.h"
#define DC_GPIO_PIN 	SPI1_MISO_PIN
#define CS_GPIO_PIN
#define RESET_PIN		SPI1_NSS_PIN
#define  RESET_OFF 		HAL_GPIO_WritePin(RESET_PIN,GPIO_PIN_SET)
#define  RESET_ON 		HAL_GPIO_WritePin(RESET_PIN,GPIO_PIN_RESET)
#define  CS_OFF 		HAL_GPIO_WritePin(CS_GPIO_PIN,GPIO_PIN_SET)
#define  CS_ON 			HAL_GPIO_WritePin(CS_GPIO_PIN,GPIO_PIN_RESET)
#define  DC_DATA 		HAL_GPIO_WritePin(DC_GPIO_PIN,GPIO_PIN_SET)
#define  DC_COMMAND 	HAL_GPIO_WritePin(DC_GPIO_PIN,GPIO_PIN_RESET)
